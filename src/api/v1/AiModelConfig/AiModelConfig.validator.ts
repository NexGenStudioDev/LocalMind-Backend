...
export type AiModelConfigCreateInput = z.infer<
  typeof aiModelConfig_CreateSchema
>;
export type AiModelConfigUpdateInput = z.infer<
  typeof aiModelConfig_UpdateSchema
>;
